...
app.use("/autopublicity", verifyAuth, resolveBrandAccessFromQuery(), autopublicityRouter);
...
app.use("/api/autopublicity", verifyAuth, resolveBrandAccessFromQuery(), autopublicityRouter);
